  ...
  return (
    ...
    >
      ...
      <select
        ...
        name={name}
        className={clsx(
          'bg-white border px-3 border-gray-200 text-gray-900 rounded-lg whitespace-nowrap focus:ring-primary-600 focus:border-primary-600 block w-full  dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500',
          {
            'text-sm ': size === 'md',
            'text-xs ': size === 'sm',
            'text-base': size === 'lg'
